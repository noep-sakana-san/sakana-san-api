...
export class Migrations1710339095740 implements MigrationInterface {
    name = 'Migrations1710339095740'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "session" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying, "startDate" TIMESTAMP NOT NULL DEFAULT '"2024-03-13T14:11:36.922Z"', "endDate" TIMESTAMP, "isVisible" boolean NOT NULL DEFAULT true, "placeId" uuid, CONSTRAINT "PK_f55da76ac1c3ac420f444d2ff11" PRIMARY KEY ("id"))`);
