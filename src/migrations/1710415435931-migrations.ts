...
export class Migrations1710415435931 implements MigrationInterface {
    name = 'Migrations1710415435931'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "session" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying, "startDate" TIMESTAMP NOT NULL DEFAULT '"2024-03-14T11:23:57.246Z"', "endDate" TIMESTAMP, "isVisible" boolean NOT NULL DEFAULT true, "placeId" uuid, CONSTRAINT "PK_f55da76ac1c3ac420f444d2ff11" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "project" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "type" "public"."project_type_enum" NOT NULL DEFAULT 'TATTOO', "date" TIMESTAMP NOT NULL DEFAULT '"2024-03-14T11:23:57.246Z"', "isVisible" boolean NOT NULL DEFAULT true, "isFavorite" boolean NOT NULL DEFAULT true, "title" character varying, "description" character varying, "placeId" uuid, CONSTRAINT "PK_4d68b1358bb5b766d3e78f32f57" PRIMARY KEY ("id"))`);
